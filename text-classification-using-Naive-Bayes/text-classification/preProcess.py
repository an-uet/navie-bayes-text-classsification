...
pickle.dump(X_data, open('C:/Users/ASUS/Desktop/text-classification-using-Naive-Bayes/text-classification/data/X_data.pkl', 'wb'))
pickle.dump(y_data, open('C:/Users/ASUS/Desktop/text-classification-using-Naive-Bayes/text-classification/data/y_data.pkl', 'wb'))
        
# File Test ----------------------------------------
test_path = 'D:/test/'        
X_test, y_test = getData(test_path)
X_test = list_to_doc(X_test)
pickle.dump(X_test, open('C:/Users/ASUS/Desktop/text-classification-using-Naive-Bayes/text-classification/data/X_test.pkl', 'wb'))
pickle.dump(y_test, open('C:/Users/ASUS/Desktop/text-classification-using-Naive-Bayes/text-classification/data/y_test.pkl', 'wb'))
