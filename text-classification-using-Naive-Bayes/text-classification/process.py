...
folder_path = 'C:/Users/ASUS/Desktop/text-classification-using-Naive-Bayes/text-classification/data/X_data.pkl'
X_data = pickle.load(open(folder_path, 'rb'))
folder_path = 'C:/Users/ASUS/Desktop/text-classification-using-Naive-Bayes/text-classification/data/y_data.pkl'
y_data = pickle.load(open(folder_path, 'rb'))
folder_path = 'C:/Users/ASUS/Desktop/text-classification-using-Naive-Bayes/text-classification/data/X_test.pkl'
X_test = pickle.load(open(folder_path, 'rb'))
folder_path = 'C:/Users/ASUS/Desktop/text-classification-using-Naive-Bayes/text-classification/data/y_test.pkl'
