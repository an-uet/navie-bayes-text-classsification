...
corpus_root  = r"C:\Users\ASUS\Desktop\Class\DataTrain"
corpus_root1 = r"C:\Users\ASUS\Desktop\Class\DataTrain\Kinh doanh"
corpus_root2 = r"C:\Users\ASUS\Desktop\Class\DataTrain\Phap luat"
corpus_root3 = r"C:\Users\ASUS\Desktop\Class\DataTrain\Suc khoe"
corpus_root4 = r"C:\Users\ASUS\Desktop\Class\DataTrain\The thao"
corpus_root5 = r"C:\Users\ASUS\Desktop\Class\DataTrain\Vi tinh"
file_pattern = r".*.txt"
        ...
        for j in range(len(freq[data.fileids()[i]])):
            if (data.words(data.fileids()[i])[j] in dictionary):
                ...
                if(data.fileids()[i].startswith('KD')):
                    location = r'C:\Users\ASUS\Desktop\Class\DataTrainFeature\Kinh doanh.txt'
                elif(data.fileids()[i].startswith('PL')):
                    location = r'C:\Users\ASUS\Desktop\Class\DataTrainFeature\Phap luat.txt'
                elif (data.fileids()[i].startswith('SK')):
                    location = r'C:\Users\ASUS\Desktop\Class\DataTrainFeature\Suc khoe.txt'
                elif (data.fileids()[i].startswith('TT')):
                    location = r'C:\Users\ASUS\Desktop\Class\DataTrainFeature\The thao.txt'
                else:
                    location = r'C:\Users\ASUS\Desktop\Class\DataTrainFeature\Vi tinh.txt'
