...
f = open(r'C:\Users\ASUS\Desktop\Class\DataTrainFeature\Kinh doanh.txt', 'r')
kinhDoanhMatrix = np.array([[int(num) for num in line.split(' ')] for line in f])
f.close()

f = open(r'C:\Users\ASUS\Desktop\Class\DataTrainFeature\Phap luat.txt', 'r')
phapLuatMatrix = np.array([[int(num) for num in line.split(' ')] for line in f])
f.close()

f = open(r'C:\Users\ASUS\Desktop\Class\DataTrainFeature\Suc khoe.txt', 'r')
sucKhoeMatrix = np.array([[int(num) for num in line.split(' ')] for line in f])
f.close()

f = open(r'C:\Users\ASUS\Desktop\Class\DataTrainFeature\The thao.txt', 'r')
theThaoMatrix = np.array([[int(num) for num in line.split(' ')] for line in f])
f.close()

f = open(r'C:\Users\ASUS\Desktop\Class\DataTrainFeature\Vi tinh.txt', 'r')
